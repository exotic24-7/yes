// Guarded authoritative DeadMenu implementation (from root) — avoids redeclaration.
(function(){
    if (typeof window !== 'undefined' && window.DeadMenu) return;
            ...
            (() => {
                ...
                class DeadMenu {
                    ...
                    drawDead(){
                        ...
                        ctx.globalAlpha = 1;
                        ctx.fillStyle = this.hoveringOverButton ? '#1cd128' : "#10c21a";
                        ctx.lineWidth = 6;
                        ...
                        if(biomeManager !== undefined && biomeManager.getCurrentBiome() === '1v1'){
                            ...
                            if (!cooldown){
                                ctx.globalAlpha = 1;
                                ctx.fillStyle = this.hoveringOverRematchButton ? '#1cd128' : "#10c21a";
                                ctx.lineWidth = 6;
                                ctx.strokeStyle = blendColor(ctx.fillStyle, "#000000", 0.2);
                                ctx.beginPath();
                    ...
                    drawWaiting(){
                        ...
                        ctx.fillStyle = this.hoveringOverButton ? '#d94747' : "#d11d1d";
                        ctx.lineWidth = 6;
                        ctx.strokeStyle = blendColor(ctx.fillStyle, "#000000", 0.2);
                        ctx.beginPath();
                        ctx.roundRect(this.buttonDimensions.x, this.buttonDimensions.y, this.buttonDimensions.w, this.buttonDimensions.h, 6);
                ...
                if (typeof window !== 'undefined') {
                    window.DeadMenu = window.DeadMenu || DeadMenu;
                } else {
                    this.DeadMenu = this.DeadMenu || DeadMenu;
                }
            })();
        ctx.fillText(mobDiedTo, canvas.w/2, canvas.h/2 - 85);
