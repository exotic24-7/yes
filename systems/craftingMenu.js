...
class CraftingMenu {
    constructor(){
        ...
        this.icon.crafting.src = 'gfx/okbutthisoneisoriginal.svg';
        this.icon.forge.src = 'gfx/forge.svg';
    ...
    drawIcon(){
        ...
        ctx.stroke();
        ctx.closePath();
        ctx.drawImage(this.icon[this.state], 20 + 15, canvas.h - 20 - 80 + 15, 80 - 15 * 2, 80 - 15 * 2);
    ...
    drawInventory(alpha = 1) {
        ...
        //         ctx.fillStyle = this.getHoverFill();
        //         setCursor('pointer');
        //         this.hoveringOverS = true;
        //     } else {
        //         // if(this.hoveringOverButton === false){
        //         //     document.body.style.cursor = 'auto';
        //         // }
        //         this.hoveringOverS = false;
        //         ctx.fillStyle = this.getMainFill();
        //     }
        // } else {
        //     ctx.fillStyle = this.getMainFill();
    ...
    mouseDown({mouseX, mouseY}, evt){
        ...
        if(this.hoveringOverCraftButton === true && this.craftingPetalContainers.length === 5){
            ...
            if(this.craftingPetalContainers[4].rarity === 11 && this.craftingPetalContainers[4].amount >= 1){
    ...
    runCraftingAnimation(){
        ...
        if(this.craftingAnimationTimer > 3000 && this.finishedCraft == true){
            if(this.craftingAnimationData.successAmount > 0){
                ...
                (function(){
                    let n = parseInt(this.craftingAnimationData.petalData.petalAmount);
                    if(!isFinite(n) || n < 0) n = 1;
                    const petals = [];
                    for(let i = 0; i < n; i++) petals.push(new Petal(this.craftingAnimationData.petalData.petal));
                    this.displayPetalContainer = new PetalContainer(petals, {...this.craftingAnimationData.petalData, toOscillate: true, w: 65, h: 65}, Math.random(), this.craftingAnimationData.successAmount);
                }).call(this);
                (function(){
                    let n = parseInt(this.craftingAnimationData.petalData.petalAmount);
                    if(!isFinite(n) || n < 0) n = 1;
                    const petals = [];
                    for(let i = 0; i < n; i++) petals.push(new Petal(this.craftingAnimationData.petalData.petal));
                    this.startRainingPetalSlots(new PetalContainer(petals, {...this.craftingAnimationData.petalData, toOscillate: true, w: 65, h: 65}, Math.random(), this.craftingAnimationData.successAmount));
                }).call(this);
